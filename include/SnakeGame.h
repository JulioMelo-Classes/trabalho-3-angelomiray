...
class SnakeGame{
    ...
    private:
        ...
        int gameMode, allFood; //guarda o modo de jogo.
        char loopChoice;
        Result gameResult;
        Player motor; //<! motor da IA
        Snake snake;
    ...
    public:
        ...
        */
        void updateScreen(GameStates stt);
    ...
    private:
        ...
        * @param gameResult_ resultado do jogo. pode ser WIN ou LOSE.
        **/
        void game_over(Result gameResult_);
        ...
        * @param snake a cobra do nível em questão.
        * @param Levels vetor que possui todos os levels do jogo.
        * @return true caso o char '*' esteja na linha; falso caso contrário.
        **/
        bool tryGetSnakeCoordinates(int lineCount, string line, Snake &snake, vector<Level> &Levels);
};
